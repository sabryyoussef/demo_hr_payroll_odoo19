...
#############################################################################
{
    ...
    'description': (
        'OH Addon: Manages employee related documents with expiry notifications. '
        'As dates approach, the system sends automated alerts so documents can '
        'be updated or renewed before they lapse.'
    ),
